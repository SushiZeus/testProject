...
export const statusColors: Record<FileStatus, string> = {
  ...
  WAITING_FOR_WHARFAGE_PAYMENT: 'bg-amber-100 text-amber-700',
  TAXES_PAID: 'bg-green-100 text-green-700',
  READY_FOR_OPERATIONS: 'bg-blue-100 text-blue-700',
  WAITING_FOR_RELEASE_ORDER: 'bg-amber-100 text-amber-700',
  ...
  OPERATIONS_DONE: 'bg-green-100 text-green-700',
  VERIFICATION_FORM_PENDING: 'bg-amber-100 text-amber-700',
  VERIFICATION_FORM_COMPLETED: 'bg-green-100 text-green-700',
